...
async function getYahooCandles() {
  ...
  return {
    ...
    v: (q && q.volume) || [],
    meta: {
      price: result.meta && result.meta.regularMarketPrice,
      pc: result.meta && (result.meta.chartPreviousClose || result.meta.previousClose),
      hi: result.meta && result.meta.regularMarketDayHigh,
      lo: result.meta && result.meta.regularMarketDayLow
    }
  };
}
